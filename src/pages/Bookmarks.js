...
const Bookmarks = () => {
  ...
  const{
    setLastPath, lastPath, rawData,setRawData,
    bookMarkedApplicants,filters,startIndex,endIndex,
  ...
  const filteredData = useMemo(() => {
      let result = bookMarkedApplicants;
    ...
    console.log(lastPath,'From the Bookmark ')
